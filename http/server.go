...
type Server struct {
	...
	errorHandler gokit.ErrorHandler
}
...
func NewServer(
	...
	s := &Server{
		...
		errorHandler: gokit.NewLogErrorHandler(log.NewNopLogger()),
	}
...
func ServerErrorLogger(logger log.Logger) ServerOption {
	return func(s *Server) { s.errorHandler = gokit.NewLogErrorHandler(logger) }
}
...
// custom ServerErrorEncoder or ServerFinalizer, both of which have access to
// the context.
func ServerErrorHandler(errorHandler gokit.ErrorHandler) ServerOption {
